...
subprojects {
    ...
    aliucord {
        author("huh_what.0_0", 1176019192365985813L)
        updateUrl.set("https://raw.githubusercontent.com/DeafThing/plugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/DeafThing/plugins/builds/%s.zip")
    }
